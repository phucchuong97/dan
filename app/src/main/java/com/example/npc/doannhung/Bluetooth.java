...
public class Bluetooth implements Serializable{
	...
	private static final String NAME = "Smart Lock";
	...
	public Bluetooth(BluetoothAdapter adapter, Handler handler) {
		mAdapter = adapter;
		mState = STATE_NONE;
		mHandler = handler;
	}
	 ...
	 * @param out
	 *            The bytes to write
	 * @see com.example.npc.doannhung.Bluetooth.ConnectedThread#write(byte[])
	 */
